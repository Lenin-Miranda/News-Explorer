    ...
    <section className="about">
      ...
      <div className="about__header-container">
        ...
        <p className="about__description">
          ...
          interactive UI components to complete applications like a social media
          platform — has come from curiosity, persistence, and a genuine love
          for coding. I aim to build things that not only work well, but make a
          difference. Let’s code something great.
        </p>
      </div>
    </section>
  );
